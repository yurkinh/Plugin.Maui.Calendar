...
public partial class CalendarNeo : ContentView
{
    ...
    {
        var control = (CalendarNeo)bindable;
    ...
    {
        if (bindable is CalendarNeo view)
        {
    ...
    {
        if (bindable is CalendarNeo calendar && calendar.ShownDate.Year != (int)newValue)
    ...
    private static void OnMonthChanged(BindableObject bindable, object oldValue, object newValue)
    {
        ...
        if (bindable is CalendarNeo calendar && calendar.ShownDate.Month != newMonth)
        {
    ...
    {
        if (
            bindable is CalendarNeo calendar
    ...
    {
        if (bindable is CalendarNeo calendar && newValue is DateTime newDateTime)
        {
    ...
    {
        if (bindable is CalendarNeo calendar && newValue is WeekLayout layout)
        {
    ...
    {
        if (bindable is CalendarNeo calendar && newValue is WeekViewUnit viewUnit)
        {
